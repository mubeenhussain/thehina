...
const EditConsultant = () =>{
  const data = useSelector(state=>{ return state.userReducer.userDetail});
  console.log("edit consultant ",data)
return(
        <>
    <Card style={{padding:'40px',border:'1px solid #DADCE0'}} >
      <Typography variant="h5" component="h2" style={{marginBottom:"20px"}} color="primary"  >Update Consultant Detail</Typography>
